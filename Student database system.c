  ...
  fp2 = fopen("Record", "r");
...

                  {
                    ...
                    if(stud.mark>=90)
                             ...
                             printf("Grade is A.   Excellent work! Keep working with full determination. ");

                       else if (stud.mark>=70)

                             printf("Grade is B.   Good job! Can achieve better score!");

                       else if (stud.mark>=50)

                             printf("Grade is C.    By working hard can get better results!");

                       else

                             printf("Grade is D.    Poor performance, Work hard!");
}
  ...
  // MAIN PROGRAM
       ...
       void main()

           {
              ...
              printf("The user will be able to insert, delete,search,update,sort,view report card and display records. \n");
